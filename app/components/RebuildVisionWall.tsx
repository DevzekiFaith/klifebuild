...
export default function RebuildVisionWall() {
  ...
  return (
    <section id="vision-wall" className="relative w-full bg-[#141414] text-white py-28 border-b border-zinc-800 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 space-y-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredDeclarations.map((item) => (
            <div
              key={item.id}
              className="p-6 bg-zinc-900/90 rounded-2xl border border-zinc-800 space-y-4 hover:border-zinc-600 transition-all flex flex-col justify-between group shadow-xl"
            >
      ...
      {isModalOpen && (
        <div
          ...
          className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto animate-fadeIn text-black"
        >
          <div className="relative w-full max-w-md bg-white p-6 sm:p-8 rounded-3xl border border-gray-200 shadow-2xl my-auto space-y-6">
