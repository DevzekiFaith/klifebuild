  ...
  if (variant === "full") {
    return (
      <div className={`flex flex-col items-center text-center ${className}`}>
        ...
        >
          LifeBuild<span style={{ fontSize: "0.6em", fontWeight: 600, marginLeft: "3px", opacity: 0.8 }}>global</span><span style={{ color: "#d4af37" }}>.</span>
        </span>
        <span
  ...
  return (
    <div className={`inline-flex items-center gap-2.5 ${className}`}>
      ...
      <div className="flex flex-col text-left leading-none">
        ...
        >
          lifebuild<span className="text-xs font-semibold ml-1 opacity-75">global</span><span style={{ color: "#d4af37" }}>.</span>
        </span>
        <span
